...
This package plans/executes **structured web intents**. It does **not** parse VOS text
and must not invent SQL. See [local-commit-protocol](./documentation/local-commit-protocol.md).
